		...
		public static void Initialize(IServiceProvider serviceProvider)
		{
				...
				.GetRequiredService<DbContextOptions<HymnDbContext>>()))
			{
				...
				context.Categories.AddRange(
					...
					new Category { Id = 15, Name = "First Advent", ParentCategoryId = 14 },
					...
					new Category { Id = 19, Name = "Resurrection and Ascension", ParentCategoryId = 14 },
					new Category { Id = 20, Name = "Priesthood", ParentCategoryId = 14 },
					new Category { Id = 21, Name = "Love Of Christ for Us", ParentCategoryId = 14 },
					new Category { Id = 22, Name = "Second Advent", ParentCategoryId = 14 },
					...
					new Category { Id = 40, Name = "DOCTRINES", ParentCategoryId = null },
